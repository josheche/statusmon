      ...
      module.exports = NodeCache2 = function () {
        class NodeCache3 extends EventEmitter2 {
          ...
          has(key) {
            ...
            boundMethodCheck(this, NodeCache3);
            _exists =
              this.data[key] != null && this._check(key, this.data[key]);
            return _exists;
          }
          getStats() {
            boundMethodCheck(this, NodeCache3);
          ...
          _isInvalidKey(key) {
            ...
            boundMethodCheck(this, NodeCache3);
            if (
              ((ref = typeof key), indexOf.call(this.validKeyTypes, ref) < 0)
            ) {
...
var require_mime_types = __commonJS({
  'node_modules/mime-types/index.js'(exports) {
    ...
    function lookup(path4) {
      ...
      var extension2 = extname('x.' + path4)
        .toLowerCase()
        .substr(1);
      if (!extension2) {
        return false;
...
var require_form_data = __commonJS({
  'node_modules/form-data/lib/form_data.js'(exports, module) {
    ...
    FormData3.prototype._generateBoundary = function () {
      this._boundary =
        '--------------------------' + crypto3.randomBytes(12).toString('hex');
    };
...
var require_follow_redirects = __commonJS({
  'node_modules/follow-redirects/index.js'(exports, module) {
    ...
    function validateUrl(input2) {
      if (
        /^\[/.test(input2.hostname) &&
        !/^\[[:0-9a-f]+\]$/i.test(input2.hostname)
      ) {
        throw new InvalidUrlError({ input: input2.href || input2 });
      }
      if (
        /^\[/.test(input2.host) &&
        !/^\[[:0-9a-f]+\](:\d+)?$/i.test(input2.host)
      ) {
        throw new InvalidUrlError({ input: input2.href || input2 });
      }
      return input2;
...
var require_bitpacker = __commonJS({
  'node_modules/pngjs/lib/bitpacker.js'(exports, module) {
    ...
    module.exports = function (dataIn, width, height, options) {
      ...
      let data =
        options.bitDepth !== 16 ? dataIn : new Uint16Array(dataIn.buffer);
      let maxValue = 255;
  ...
  'node_modules/pngjs/lib/sync-inflate.js'(exports, module) {
    ...
    Inflate.prototype._processChunk = function (chunk, flushFlag, asyncCb) {
      if (typeof asyncCb === 'function') {
        return zlib2.Inflate._processChunk.call(
          this,
          chunk,
          flushFlag,
          asyncCb,
...
var require_png = __commonJS({
  'node_modules/pngjs/lib/png.js'(exports) {
    ...
    PNG2.prototype.bitblt = function (
      dst,
      srcX,
      srcY,
      width,
    ...
    if (authoritySessions) {
      ...
      for (let i = 0; i < len; i++) {
        ...
        if (
          ...
          util2.isDeepStrictEqual(sessionOptions, options)
        ) {
    ...
    return wrapAsync(
      async function dispatchHttpRequest(resolve, reject, onDone) {
        ...
        onDone((response, isRejected) => {
          ...
          if (
            data2 instanceof stream3.Readable ||
            data2 instanceof stream3.Duplex
          ) {
...
var Pokedex = class {
  constructor(options) {
    this.options = new PokeAPIOptions_default(
      options,
      new import_node_cache.default(),
    );
  }
  async getResource(endpoint, callback) {
    try {
      if (!endpoint) {
        throw new Error(
          'Param "endpoint" is required needs to be a string or array of strings',
        );
      }
  ...
  async getBerryByName(nameOrId, callback) {
    try {
      if (!nameOrId) {
        throw new Error(
          'Param "nameOrId" is required (Must be a string, array of strings or array of string and/or numbers )',
        );
      }
      if (
        !Array.isArray(nameOrId) &&
        typeof nameOrId !== 'number' &&
        typeof nameOrId !== 'string'
      ) {
        throw new Error(
          'Param "nameOrId" must be a string, array of strings or array of string and/or numbers',
        );
      }
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}berry/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}berry/${nameOrIds}/`,
        );
        return queryRes;
      };
  ...
  async getBerryFirmnessByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}berry-firmness/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}berry-firmness/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getBerryFlavorByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}berry-flavor/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}berry-flavor/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getContestTypeByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}contest-type/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}contest-type/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getContestEffectById(id, callback) {
    try {
      if (!id) {
        throw new Error(
          'Param "id" is required (Must be a number or array of numbers )',
        );
      }
      if (
        !Array.isArray(id) &&
      ...
      if (typeof id === 'number' || typeof id === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}contest-effect/${id}/`,
          callback,
        );
      }
      const mapper = async (ids) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}contest-effect/${ids}/`,
        );
        return queryRes;
      };
  ...
  async getSuperContestEffectById(id, callback) {
    try {
      ...
      if (typeof id === 'number' || typeof id === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}super-contest-effect/${id}/`,
          callback,
        );
      }
      const mapper = async (ids) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}super-contest-effect/${ids}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(id, mapper, { concurrency: 4 });
  ...
  async getEncounterMethodByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}encounter-method/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}encounter-method/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getEncounterConditionByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}encounter-condition/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}encounter-condition/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getEncounterConditionValueByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}encounter-condition-value/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}encounter-condition-value/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getEvolutionChainById(id, callback) {
    try {
      ...
      if (typeof id === 'number' || typeof id === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}evolution-chain/${id}/`,
          callback,
        );
      }
      const mapper = async (ids) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}evolution-chain/${ids}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(id, mapper, { concurrency: 4 });
  ...
  async getEvolutionTriggerByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}evolution-trigger/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}evolution-trigger/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getGenerationByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}generation/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}generation/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getPokedexByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokedex/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokedex/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getVersionByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}version/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}version/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getVersionGroupByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}version-group/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}version-group/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getItemByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}item/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}item/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getItemAttributeByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}item-attribute/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}item-attribute/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getItemCategoryByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}item-category/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}item-category/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getItemFlingEffectByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}item-fling-effect/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}item-fling-effect/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getItemPocketByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}item-pocket/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}item-pocket/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getMachineById(id, callback) {
    try {
      ...
      if (typeof id === 'number' || typeof id === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}machine/${id}/`,
          callback,
        );
      }
      const mapper = async (ids) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}machine/${ids}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(id, mapper, { concurrency: 4 });
  ...
  async getMoveByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getMoveAilmentByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move-ailment/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move-ailment/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getMoveBattleStyleByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move-battle-style/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move-battle-style/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getMoveCategoryByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move-category/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move-category/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getMoveDamageClassByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move-damage-class/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move-damage-class/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getMoveLearnMethodByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move-learn-method/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move-learn-method/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getMoveTargetByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move-target/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move-target/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getLocationByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}location/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}location/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getLocationAreaByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}location-area/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}location-area/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getPalParkAreaByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pal-park-area/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pal-park-area/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getRegionByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}region/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}region/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getAbilityByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}ability/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}ability/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getCharacteristicById(id, callback) {
    try {
      ...
      if (typeof id === 'number' || typeof id === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}characteristic/${id}/`,
          callback,
        );
      }
      const mapper = async (ids) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}characteristic/${ids}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(id, mapper, { concurrency: 4 });
  ...
  async getEggGroupByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}egg-group/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}egg-group/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getGenderByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}gender/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}gender/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getGrowthRateByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}growth-rate/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}growth-rate/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getNatureByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}nature/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}nature/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getPokeathlonStatByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokeathlon-stat/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokeathlon-stat/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getPokemonByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokemon/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokemon/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getPokemonColorByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokemon-color/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokemon-color/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getPokemonFormByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokemon-form/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokemon-form/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getPokemonHabitatByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokemon-habitat/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokemon-habitat/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getPokemonShapeByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokemon-shape/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokemon-shape/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getPokemonSpeciesByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokemon-species/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokemon-species/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getStatByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}stat/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}stat/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getTypeByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}type/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}type/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getLanguageByName(nameOrId, callback) {
    try {
      ...
      if (typeof nameOrId === 'number' || typeof nameOrId === 'string') {
        return Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}language/${nameOrId}/`,
          callback,
        );
      }
      const mapper = async (nameOrIds) => {
        const queryRes = await Getter_default(
          this.options,
          `${this.options.protocol}${this.options.hostName}${this.options.versionPath}language/${nameOrIds}/`,
        );
        return queryRes;
      };
      const mappedResults = await pMap(nameOrId, mapper, { concurrency: 4 });
  ...
  async getBerriesList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}berry/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getBerriesFirmnessList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}berry-firmness/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getBerriesFlavorsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}berry-flavor/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getContestTypesList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}contest-type/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getContestEffectsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}contest-effect/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getSuperContestEffectsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}super-contest-effect/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getEncounterMethodsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}encounter-method/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getEncounterConditionsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}encounter-condition/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getEncounterConditionValuesList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}encounter-condition-value/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getEvolutionChainsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}evolution-chain/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getEvolutionTriggersList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}evolution-trigger/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getGenerationsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}generation/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getPokedexsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokedex/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getVersionsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}version/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getVersionGroupsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}version-group/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getItemsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}item/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getItemAttributesList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}item-attribute/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getItemCategoriesList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}item-category/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getItemFlingEffectsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}item-fling-effect/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getItemPocketsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}item-pocket/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getMachinesList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}machine/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getMovesList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getMoveAilmentsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move-ailment/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getMoveBattleStylesList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move-battle-style/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getMoveCategoriesList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move-category/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getMoveDamageClassesList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move-damage-class/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getMoveLearnMethodsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move-learn-method/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getMoveTargetsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}move-target/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getLocationsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}location/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getLocationAreasList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}location-area/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getPalParkAreasList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pal-park-area/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getRegionsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}region/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getAbilitiesList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}ability/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getCharacteristicsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}characteristic/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getEggGroupsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}egg-group/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getGendersList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}gender/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getGrowthRatesList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}growth-rate/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getNaturesList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}nature/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getPokeathlonStatsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokeathlon-stat/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getPokemonsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokemon/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getPokemonColorsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokemon-color/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getPokemonFormsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokemon-form/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getPokemonHabitatsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokemon-habitat/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getPokemonShapesList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokemon-shape/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getPokemonSpeciesList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}pokemon-species/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getStatsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}stat/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getTypesList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}type/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getLanguagesList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}language/?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
  ...
  async getEndpointsList(interval, callback) {
    try {
      ...
      return Getter_default(
        this.options,
        `${this.options.protocol}${this.options.hostName}${this.options.versionPath}?limit=${limit}&offset=${offset}`,
        callback,
      );
    } catch (error) {
      ErrorHandler_default(error, callback);
...
process.stdin.on('end', () => {
  main().catch((e) =>
    process.stderr.write(`statusmon: ${e.message}
`),
  );
});
async function main() {
...
async function miniSprite(pokemonId, size = 48) {
  const { PNG: PNG2 } = await Promise.resolve().then(() =>
    __toESM(require_png(), 1),
  );
  const { fetchSprite: fetchSprite2 } = await Promise.resolve().then(
    () => (init_cache(), cache_exports),
  );
